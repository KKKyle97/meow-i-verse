<template>
  <div class="account-selection">
    <div class="account-selection__dummy"></div>
    <div class="account-selection__main">
      <button>
        <div class="account-selection__main__account-name">
          <span>tellurium</span>
        </div>
        <div class="account-selection__main__chevron-down">
          <svg
    ...
    <div class="account-selection__edit">
      <svg
